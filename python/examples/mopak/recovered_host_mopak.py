...
stream = 'mopak_o_dcl_accel_recovered'          # OOI Net stream name
...
# We are after recovered_host data. Determine list of deployments and use the next to last, presumably the last
# completed, deployment to determine the start and end dates for our request.
